<template>
    <div class="person">
        <div class="person-infor">
            <dl>
                <dt><img src="../assets/images/papulity.png" alt=""></dt>
                <dd>帅到没朋友</dd>
            </dl>
            <span class="my-mon">￥0</span>
        </div>
        ...
        <ul class="person-dif-con">
            ...
            <li class="person-seller-con clearfix">
                <router-link to="/unpaid" class="person-sended" replace>已发货</router-link>
                <router-link to="/wait_send" class="person-transaction" replace>交易中</router-link>
                <router-link to="/wait_sure" class="person-shelves" replace>已上架</router-link>
        ...
        <div class="person-income-con clearfix">
            <router-link to="/my_code" class="person-code" replace>我的二维码<span></span></router-link>
            <router-link to="/my_promotion" class="person-promotion" replace>我的推广<span></span></router-link>
            <router-link to="/income_con" class="person-income" replace>收益祥情<span></span></router-link>
            <router-link to="/certification" class="person-cer" replace>实名认证<em>未认证</em><span></span></router-link>
        </div>
    </div>
</template>
<style>
